...
WindowsSocketClient::WindowsSocketClient():socketClient(0),port(11411),addr((char*)"127.0.0.1")
{

}

WindowsSocketClient::WindowsSocketClient(int port,char *addr):socketClient(0),port(port),addr(addr)
{
...
void WindowsSocketClient::set_port(int port)
{
    this->port = port;
}

void WindowsSocketClient::set_addr(char* addr)
{
//    if(this->addr)
//        free(this->addr);
